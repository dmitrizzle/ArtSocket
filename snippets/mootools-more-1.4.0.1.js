...
// Load this file's selection again by visiting: http://mootools.net/more/f01d3d4de7b025d96639e29158487904 
// Or build this file again with packager using: packager build More/Number.Format More/Fx.Elements More/Fx.Scroll More/Request.JSONP More/Assets
/*
---
copyrights:
...
}a.decimals=b!=null?b:(a.decimals==null?2:a.decimals);return this.format(a);}});Fx.Elements=new Class({Extends:Fx.CSS,initialize:function(b,a){this.elements=this.subject=$$(b);
